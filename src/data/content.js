...
export const about = {
  ...
  body: [
    "Studied computer science at Columbia and economics at Sciences Po Paris, two schools, two ways of thinking about systems. Started in EdTech building tools for learning programs, then moved into deployment strategy, working directly with enterprise customers to turn real problems into software that actually gets used.",
  ],
  highlights: [],
}
...
export const projects = [
  {
    ...
    blurb:
      'An app for non-verbal users to express themselves by tapping icons on their Apple Watch or iPhone, while caregivers and supporters follow along in real time through a companion mobile app.',
